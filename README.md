...
전체 백엔드 코드를 기준으로 정리하되 **제가 담당한 기능은 따로 명시**했습니다.
...
이 프로젝트에서 제가 중점적으로 구현하고 정리한 부분은 다음과 같습니다.
...
- json 응답 규격을 짜는 방법
- 프론트엔드와 협엽하며 api 매핑의 중요성과 json 응답 규격의 중요성
---
## 회고
4명의 팀원을 이끄는 팀장으로서 진행한
LiveCoder는 제가 진행한 프로젝트 중에서도
